...
export default function Partners(){return <main id="contenu">
 <section className="page-hero partners-hero wrap"><p className="eyebrow">Le cercle local</p><h1>De belles marques.<br/><em>De vraies idées.</em></h1><p>Émilie ouvre son écosystème aux entreprises qui veulent aider les propriétaires, enrichir la vie de quartier et créer des collaborations qui ont du sens.</p><a className="button dark" href="#proposer">Proposer une collaboration <ArrowUpRight size={18}/></a></section>
