...
export const BOOKS_EN: Record<string, { title: string; subtitle: string }> = {
  'devenir-proprietaire-au-quebec': { title: 'Becoming a Homeowner in Quebec', subtitle: 'The complete first-time buyer’s guide — from the idea to the keys' },
  'cinq-erreurs-a-10000-de-l-acheteur': { title: 'The 5 Mistakes That Cost Buyers $10,000', subtitle: 'Costly first-purchase traps — and how to avoid them' },
  'la-preapprobation-hypothecaire-decodee': { title: 'Mortgage Pre-Approval, Decoded', subtitle: 'Understand, prepare for and secure strong financing' },
  'la-taxe-de-bienvenue-expliquee': { title: 'The Welcome Tax, Explained', subtitle: 'Quebec land transfer duties — calculation, deadline and special cases' },
  'acheter-en-copropriete-condo': { title: 'Buying a Condo in Co-Ownership', subtitle: 'Declaration, contingency fund and fees — buy with no bad surprises' },
  'checklist-visite-inspection': { title: 'Property Visit & Inspection Checklist', subtitle: "The buyer’s checklist for seeing past the decor" },
  'promesse-achat-gagnante': { title: 'Writing a Strong Promise to Purchase', subtitle: 'Price, conditions, deadlines and offer strategy — without trapping yourself' },
  'duplex-triplex-habiter-louer': { title: 'Buying a Duplex or Triplex to Live In and Rent Out', subtitle: 'Become an owner-occupant while tenants help pay the mortgage' },
  'acheter-neuf-vs-ancien-gcr': { title: 'Buying New vs. Existing Property', subtitle: 'New construction, GCR warranty and resale homes — how to choose well' },
  'financer-mise-de-fonds-rap-celiapp-don': { title: 'Financing Your Down Payment', subtitle: 'HBP, FHSA and family gifts — build your down payment wisely' },
  'choisir-son-quartier-laval-rive-nord': { title: 'Choosing the Right Neighbourhood', subtitle: 'Laval and the North Shore — find the area that fits your life' },
  ...
  'les-vrais-frais-de-l-achat': { title: 'The Real Costs of Buying', subtitle: 'Notary, inspection, adjustments and more — the full budget, no surprises' },
  ...
  'vendre-au-meilleur-prix-7-etapes': { title: 'Selling at the Best Price', subtitle: 'The 7-step game plan — from pricing to closing' },
  ...
  'declaration-du-vendeur-vices-caches': { title: "The Seller’s Declaration", subtitle: 'Avoid latent defects and lawsuits — sell with peace of mind' },
  ...
  'gerer-les-offres-multiples-vendeur': { title: 'Handling Multiple Offers as a Seller', subtitle: 'Turn competition into a better outcome, without losing control' },
  ...
  'premier-immeuble-a-revenus': { title: 'Your First Income Property', subtitle: 'Buy your first plex without costly mistakes — profitability, financing, management' },
  'calculer-la-rentabilite': { title: 'Calculating Rental Profitability', subtitle: 'Cash flow, cap rate and GRM — the numbers that drive the decision' },
  'financer-immeuble-a-revenus': { title: 'Financing an Income Property', subtitle: 'Down payment, CMHC and structure — get the right rental financing' },
  'fiscalite-investisseur-immobilier': { title: 'Taxes for Real Estate Investors', subtitle: 'Rental income, expenses, depreciation and capital gains in Quebec' },
  'locataires-et-tal': { title: 'Tenants and the TAL', subtitle: 'Leases, rent increases and rights — manage tenants properly in Quebec' },
  'reprise-de-logement-et-eviction': { title: 'Repossession and Eviction', subtitle: 'The Quebec legal framework — understand your rights and limits' },
  'renover-pour-creer-de-la-valeur-flip': { title: 'Renovating to Create Value', subtitle: 'Flips and added value — renovate strategically, not at a loss' },
  'location-court-terme-airbnb-legalite': { title: 'Short-Term Rentals and Airbnb', subtitle: "What is legal in Quebec before you get into short-term rentals" },
  'batir-un-portefeuille-immobilier': { title: 'Building a Real Estate Portfolio', subtitle: 'From 1 to 5 doors — grow your real estate wealth step by step' },
  'comprendre-la-loi-sur-le-courtage': { title: 'Understanding the Real Estate Brokerage Act', subtitle: 'Your consumer rights — how real estate brokerage is regulated in Quebec' },
  'le-role-du-notaire': { title: "The Notary’s Role", subtitle: 'What the notary does in a Quebec real estate transaction' },
  ...
  'marche-grand-montreal-cycles': { title: 'The Greater Montreal Market', subtitle: 'Read market cycles to buy and sell with better judgment' },
  'acheter-vendre-en-hiver': { title: 'Buying or Selling in Winter', subtitle: 'Myths and realities of winter real estate in Quebec' },
  ...
  'copropriete-divise-vs-indivise': { title: 'Divided vs. Undivided Co-Ownership', subtitle: 'Two very different ways to own a condo — choose the right one' },
  'acheter-a-deux': { title: 'Buying as a Couple', subtitle: 'Common-law partners, undivided co-ownership and agreements — protect yourselves' },
  'premier-achat-nouveaux-arrivants': { title: 'First Home Purchase for Newcomers', subtitle: 'Buying in Quebec when you come from elsewhere — key steps and local rules' },
  'acheter-et-vendre-en-meme-temps': { title: 'Buying and Selling at the Same Time', subtitle: 'Move without getting stuck — coordinate both transactions' },
  'retraite-et-immobilier-downsizing': { title: 'Retirement, Real Estate and Downsizing', subtitle: 'Downsize, free up cash and make real estate work for retirement' },
  'aider-son-enfant-a-acheter': { title: 'Helping Your Child Buy a Home', subtitle: 'Gift, loan or co-signing — support them without putting yourself at risk' },
  'acheter-un-chalet-residence-secondaire': { title: 'Buying a Cottage or Second Home', subtitle: 'A second home in Quebec — dream, reality and essential checks' },
};
